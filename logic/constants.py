...
# Sheet headers
ENCABEZADOS_HORAS = ["Dia", "Fecha", "Hora entrada", "Salgo almuerzo", "Vuelta almuerzo", "Hora salida", "Horas"]
ENCABEZADOS_LIBRO_DIARIO = ["Fecha", "Movimiento", "Proveedor/Cliente", "Nro Factura", "Neto", "IVA", "Total", "Categoría", "Comprobante", "Rastro/Foto", "Mes"]
ENCABEZADOS_MATERIAS = ["Día", "Fecha", "Hora Teórica", "Asistencia Teórica", "Hora Práctica", "Asistencia Práctica"]
