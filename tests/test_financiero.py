...
class TestFinancieroLogic(unittest.TestCase):
    ...
    def test_get_active_debts(self, MockRepo):
        ...
        repo_instance.get_obligaciones_activas.return_value = [
            {"ID_Obligacion": "123", "Estado": "Activo"}
        ]
    ...
    def test_register_payment(self, MockCalendar, MockRepo):
        ...
        repo_instance.update_obligacion_saldo.assert_called_once_with(
            "123", 0, 4, "Saldada"
        )
    ...
    def test_execute_monthly_closing(
        self, mock_open, mock_get_now, MockDrive, MockRepo
    ):
        import datetime
        ...
        repo_instance.get_movimientos_mes.return_value = [
            {
                ...
                "Total": 1000000,
                "Monto_IVA": 90909,
                "Clasificacion_IVA": "Débito Fiscal",
                "Categoría": "Ventas",
            },
            {
                "Movimiento": "Egreso",
                "Total": 200000,
                "Monto_IVA": 18182,
                "Clasificacion_IVA": "Crédito Fiscal",
                "Categoría": "Insumos",
            },
            {
                "Movimiento": "Egreso",
        ...
        self.assertEqual(
            cierre2["Saldo_Acumulado"], 0 + 500000 - 800000 - max(45454 - 72727, 0)
        )
